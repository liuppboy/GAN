...
class FontDataManager(object):
    def __init__(self, src, target, train_size, validation_size, unit_scale=True, shuffle=False):
        ...
        self.train_source = FontDataProvider(src_data, 0, train_size)
        self.validation_source = FontDataProvider(src_data, train_size, train_size + validation_size)
        self.train_target = FontDataProvider(target_data, 0, train_size)
        self.validation_target = FontDataProvider(target_data, train_size, train_size + validation_size)
